...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{../figs/eda_01_target_distribution.png}
\caption{Distribution de la Variable Cible (Response)}
\label{fig:target_dist}
\end{figure}

\textbf{Observation critique:} Le dataset présente un déséquilibre de classes important avec un ratio de 7:1 entre les non-souscriptions et les souscriptions. Cette caractéristique nécessite une attention particulière lors de la modélisation.

\subsection{Analyse des Variables Numériques}

\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{../figs/eda_02_age_distribution.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{../figs/eda_03_premium_distribution.png}
\caption{Distribution de la Prime Annuelle (avec Outliers)}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{../figs/eda_07_damage_vs_response.png}
\caption{Vehicle\_Damage vs Response}
\label{fig:damage_response}
\end{figure}

\textbf{Insight clé:} Les clients dont le véhicule a été endommagé sont significativement plus susceptibles de souscrire à l'assurance vie (taux de ~22\% vs ~1\% pour les véhicules non endommagés).

\subsection{Matrice de Corrélation}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../figs/eda_12_correlation_matrix.png}
...
\begin{itemize}
    \item \texttt{Vehicle\_Damage}: +0.45 (corrélation positive forte)
    \item \texttt{Previously\_Insured}: -0.35 (corrélation négative)
    \item \texttt{Vehicle\_Age}: +0.15 (corrélation positive modérée)
\end{itemize}
...
SVM & 0.7712 ± 0.0019 & 0.7734 ± 0.0018 & 0.8521 ± 0.0016 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{../figs/model_01_cv_comparison.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../figs/model_03_roc_curves.png}
\caption{Courbes ROC - Comparaison des Modèles}
...
\subsection{Matrice de Confusion - Meilleur Modèle}

\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{../figs/model_02_confusion_matrix.png}
\caption{Matrice de Confusion - XGBoost (Tuned)}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{../figs/model_04_feature_importance.png}
\caption{Importance des Variables (Random Forest vs XGBoost)}
